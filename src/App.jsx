...
const PROMPTS = [
  { en: "Describe your morning routine", ar: "وصف روتينك الصباحي" },
  { en: "Talk about a decision you made this week", ar: "تكلم عن قرار اتخذته" },
  { en: "Explain your job to someone new", ar: "اشرح وظيفتك لشخص جديد" },
  { en: "Describe a challenge at work", ar: "وصف تحدي في العمل" },
  { en: "Summarize a recent meeting", ar: "لخّص اجتماع حضرته" },
  { en: "Talk about what makes a good leader", ar: "صفات القائد الجيد" },
  { en: "Describe your weekend plans", ar: "خططك لنهاية الأسبوع" },
  { en: "Explain a project you work on", ar: "مشروع تشتغل عليه" },
  { en: "Talk about a goal for this year", ar: "هدف تبي تحققه" },
  { en: "Describe a typical workday", ar: "يوم عمل عادي" },
];
const PHRASES = [
